...
public class PolygonTool : IDrawingTool
{
    ...
    public string StatusText => _points.Count switch
    {
        ...
        2 => "Click to add points, double-click or Enter to close, Escape to cancel",
        _ => $"{_points.Count} points - Click to add, double-click or Enter to close, Escape to cancel"
    };
